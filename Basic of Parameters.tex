...
%%%%%%%%%%%%% Set parameters:
\tikzmath{\a=3; \b=4; \c=4;}
%%%%%%%%%%%%%% Use them in the problem
\item What is the derivative of $f(x)=\a x^3+\b x^2 +\c$?\\
...
\hrule
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%% If you are interested in Linear algebra, you can still use those parameters:
\item What is the inverse of $\left[\begin{array}{cc}
    \a &\b  \\
     \c& 1
\end{array}\right]$ ?
...
%%%This obliviously needs better work if it is sued for student. But each problem is different in tjose extra steps.
...
\hrule
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%If you are interested in problems with graphs:

\item Draw the graph of derivative of $f(x)$.

\begin{center}\begin{tikzpicture}
\foreach \x/\y/\pos/\txt in {2/0/right/x,0/3/above/y}
...
\draw [red, line width=1pt, smooth,shift={(1,0)}]plot[variable=\t, domain=-1:1.5](\t,{0.12*(\athree*(\t)^2-\btwo*\t})node[above]{$f'(x)$};
\end{tikzpicture}\end{center}
